...
TransitOnRails is a web application built for viewing Washington, DC transit information. The application borrows it's ideas and styling (for now) from https://github.com/MobilityLab/TransitScreen and was largely built as a though-exercise in converting a codeigniter app to Rails.

==Getting Started

TransitOnRails runs like any Rails application. Clone the application to your repository and set up
your database:
  rake db:create
  rake db:migrate
